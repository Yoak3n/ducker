            ...
            <div className="mb-3">
                <div className="flex flex-col gap-2">
                    <div className='flex flex-row items-center gap-2'>
                        ...
                        />
                        <label className="font-medium text-muted-foreground cursor-default">{t("Set as Periodic Task")}</label>
                    </div>
                    <span className="text-sm text-muted-foreground italic ml-6">{t("Enable to repeat the task at the set interval")}</span>
                </div>
            </div>
                                    ...
                                    {periodOptions.map(option => (
                                        <SelectItem key={option.value} value={option.value.toString()}>
                                            <div className="flex gap-1">
                                                <span className="font-medium text-muted-foreground">{t(option.label)}</span>
